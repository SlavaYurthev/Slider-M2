 ...
 */
namespace SY\Slider\Model\System\Message;
...
class Advertisment implements \Magento\Framework\Notification\MessageInterface {
	...
	public function getText(){
		...
		$html .= "<p>Do you want to <strong><a href=\"".$this->urlInterface->getUrl('sy_slider/advertisment/subscribe')."\" target=\"_blank\">check this for free</a></strong> or just <a href=\"".$this->urlInterface->getUrl('sy_slider/advertisment/close')."\">close</a> this message?</p>";
